...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'site_frame.tpl', 24, false),array('modifier', 'h', 'site_frame.tpl', 24, false),array('modifier', 'strlen', 'site_frame.tpl', 27, false),array('modifier', 'count', 'site_frame.tpl', 103, false),)), $this); ?>
<!DOCTYPE HTML>
...
">
    <head>
		...
		<?php if (((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrPageLayout']['robots'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('strlen', true, $_tmp) : strlen($_tmp)) >= 1 && ((is_array($_tmp=$this->_tpl_vars['arrProduct']['nofollow_flg'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == '1'): ?>
		<meta name="robots" content="<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrPageLayout']['robots'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
" />
		<?php endif; ?>
		<?php if (((is_array($_tmp=$this->_tpl_vars['tpl_title'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == "クレジットカードまたはPayPalでお支払い"): ?>
...
js/news.js"></script>
                ...
                <link rel="stylesheet" media="only screen" href="<?php echo ((is_array($_tmp=$this->_tpl_vars['TPL_URLPATH'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
js/jquery.mobile/jquery.mobile-1.2.1.min.css" />
        <script src="<?php echo ((is_array($_tmp=$this->_tpl_vars['TPL_URLPATH'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
js/config.js"></script>
        <script src="<?php echo ((is_array($_tmp=$this->_tpl_vars['TPL_URLPATH'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
js/jquery.mobile/jquery.mobile-1.2.1.min.js"></script>
