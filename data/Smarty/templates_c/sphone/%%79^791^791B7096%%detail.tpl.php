<?php /* Smarty version 2.6.26, created on 2014-01-09 10:50:11
         compiled from /var/www/html/naitei-bank/html/../data/Smarty/templates/sphone/products/detail.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', '/var/www/html/naitei-bank/html/../data/Smarty/templates/sphone/products/detail.tpl', 23, false),array('modifier', 'h', '/var/www/html/naitei-bank/html/../data/Smarty/templates/sphone/products/detail.tpl', 88, false),array('modifier', 'nl2br_html', '/var/www/html/naitei-bank/html/../data/Smarty/templates/sphone/products/detail.tpl', 130, false),array('modifier', 'sfPrePoint', '/var/www/html/naitei-bank/html/../data/Smarty/templates/sphone/products/detail.tpl', 206, false),array('modifier', 'number_format', '/var/www/html/naitei-bank/html/../data/Smarty/templates/sphone/products/detail.tpl', 206, false),array('modifier', 'strlen', '/var/www/html/naitei-bank/html/../data/Smarty/templates/sphone/products/detail.tpl', 219, false),array('modifier', 'sfGetErrorColor', '/var/www/html/naitei-bank/html/../data/Smarty/templates/sphone/products/detail.tpl', 248, false),array('modifier', 'default', '/var/www/html/naitei-bank/html/../data/Smarty/templates/sphone/products/detail.tpl', 280, false),array('modifier', 'u', '/var/www/html/naitei-bank/html/../data/Smarty/templates/sphone/products/detail.tpl', 409, false),array('function', 'html_options', '/var/www/html/naitei-bank/html/../data/Smarty/templates/sphone/products/detail.tpl', 250, false),)), $this); ?>
...
<section id="product_detail">
    ...
    <section id="detailarea">
        ...
        <?php if (((is_array($_tmp=$this->_tpl_vars['tpl_login'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>
        	<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrProduct']['customer_comment'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('nl2br_html', true, $_tmp) : smarty_modifier_nl2br_html($_tmp)); ?>
...
img/button/btn_minus.png" onclick="fnSubToggle($('#sub_area'), this);" alt=""></span>
        </div>
        <div id="sub_area">
...
" />
    ...
    <?php if (((is_array($_tmp=$this->_tpl_vars['arrRecommend'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp))): ?>
        <div class="title_box_sub clearfix">
            <h2>その他のオススメ商品</h2>
            <span class="b_expand"><img src="<?php echo ((is_array($_tmp=$this->_tpl_vars['TPL_URLPATH'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
img/button/btn_minus.png" onclick="fnWhoboughtToggle($('#whobought_area'), this);" alt=""></span>
        </div>
...
">
                            ...
                            <?php $this->assign('price02_min', ($this->_tpl_vars['arrRecommend'][$this->_sections['cnt']['index']]['price02_min_inctax'])); ?>
                            <?php $this->assign('price02_max', ($this->_tpl_vars['arrRecommend'][$this->_sections['cnt']['index']]['price02_max_inctax'])); ?>
...
"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrRecommend'][$this->_sections['cnt']['index']]['name'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
							...
							<p style="overflow: hidden;"><?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrRecommend'][$this->_sections['cnt']['index']]['comment'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('nl2br_html', true, $_tmp) : smarty_modifier_nl2br_html($_tmp)); ?>
</p>
    ...
    <div class="btn_area">
        <p><a href="javascript:void(0);" class="btn_more" data-rel="back">検索結果一覧に戻る</a></p>
    </div>
</section>
