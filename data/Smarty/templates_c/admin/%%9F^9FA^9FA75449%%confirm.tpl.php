...
">
 ...
 ％<?php endif; ?>
        ...
        <tr>
            <th>会員用コンテンツ</th>
            <td>
                <?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['customer_comment'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('nl2br_html', true, $_tmp) : smarty_modifier_nl2br_html($_tmp)); ?>
        ...
        <tr>
        	<th>nofollowフラグ</th>
            <td>
            	<?php if (((is_array($_tmp=$this->_tpl_vars['arrForm']['nofollow_flg'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == 1): ?>ON<?php else: ?>OFF<?php endif; ?>
            </td>
		</tr>
        <tr>
            <th>一覧-メイン画像</th>
