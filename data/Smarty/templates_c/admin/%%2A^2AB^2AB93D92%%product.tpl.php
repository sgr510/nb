<?php /* Smarty version 2.6.26, created on 2014-01-09 11:27:27
         compiled from products/product.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'script_escape', 'products/product.tpl', 62, false),array('modifier', 'h', 'products/product.tpl', 66, false),array('modifier', 'sfGetErrorColor', 'products/product.tpl', 160, false),array('modifier', 'default', 'products/product.tpl', 211, false),array('modifier', 'function_exists', 'products/product.tpl', 341, false),array('modifier', 'sfNoImageMainList', 'products/product.tpl', 428, false),array('function', 'html_options', 'products/product.tpl', 116, false),array('function', 'html_radios', 'products/product.tpl', 126, false),array('function', 'html_checkboxes', 'products/product.tpl', 132, false),)), $this); ?>
...
文字)</span>
        ...
        <tr>
            <th>会員用コンテンツ<span class="attention">(タグ許可)*</span></th>
            <td>
                <span class="attention"><?php echo ((is_array($_tmp=$this->_tpl_vars['arrErr']['customer_comment'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
</span>
                <textarea name="customer_comment" maxlength="<?php echo ((is_array($_tmp=@LLTEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
" style="<?php if (((is_array($_tmp=$this->_tpl_vars['arrErr']['customer_comment'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) != ""): ?>background-color: <?php echo ((is_array($_tmp=@ERR_COLOR)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
;<?php endif; ?>" cols="60" rows="8" class="area60"><?php echo "\n"; ?>
<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['arrForm']['customer_comment'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)))) ? $this->_run_mod_handler('h', true, $_tmp) : smarty_modifier_h($_tmp)); ?>
</textarea><br />
                <span class="attention"> (上限<?php echo ((is_array($_tmp=@LLTEXT_LEN)) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)); ?>
文字)</span>
            </td>
        ...
        <tr>
            <th>nofollowフラグ</th>
            <td>
                <input type="checkbox" name="nofollow_flg" value="1" <?php if (((is_array($_tmp=$this->_tpl_vars['arrForm']['nofollow_flg'])) ? $this->_run_mod_handler('script_escape', true, $_tmp) : smarty_modifier_script_escape($_tmp)) == '1'): ?>checked<?php endif; ?> />nofollowにする
            </td>
        </tr>
