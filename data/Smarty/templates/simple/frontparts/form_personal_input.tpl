            ...
            <td>
	            ...
	            <table summary="お支払方法選択" id="payment" style="border: none; margin:5px 0;">
	            	<!--{section name=cnt loop=$arrPayment}-->
	                	<tr>
	                        <td class="alignC" style="border: none; width:1%; padding:3px;"><input style="margin:0;" type="radio" id="pay_<!--{$smarty.section.cnt.iteration}-->" name="<!--{$key}-->"  value="<!--{$arrPayment[cnt].payment_id}-->" style="<!--{$arrErr[$key]|sfGetErrorColor}-->" <!--{$arrPayment[cnt].payment_id|sfGetChecked:$arrForm[$key].value}--> /></td>
