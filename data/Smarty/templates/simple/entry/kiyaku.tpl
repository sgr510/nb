 ...
 *}-->
        ...
        <textarea style="color:#666;" name="textfield" class="kiyaku_text" cols="80" rows="10" readonly="readonly"><!--{$tpl_kiyaku_text|h}--></textarea>
        ...
        <div class="btn_area">
            <ul>
                ...
                <li>
                    <a href="<!--{$smarty.const.ENTRY_URL}-->" onmouseover="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_entry_agree2_on.jpg','b_agree');" onmouseout="chgImg('<!--{$TPL_URLPATH}-->img/button/btn_entry_agree2.jpg','b_agree');">
                <img src="<!--{$TPL_URLPATH}-->img/button/btn_entry_agree2.jpg" alt="同意して会員登録へ" border="0" name="b_agree" /></a>
                </li>
            </ul>
        </div>
