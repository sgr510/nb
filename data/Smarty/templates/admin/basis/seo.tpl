...
<!--{* 2013.12.05 Added by KACR *}-->                            
                            <tr>
                                <th>メタタグ:Robots</th>
                                <td>
                                <span class="attention"><!--{$arrErr[$item.device_type_id][$item.page_id].robots}--></span>
                                <input type="text" name="meta[<!--{$item.device_type_id}-->][<!--{$item.page_id}-->][robots]" value="<!--{$item.robots|h}-->" maxlength="<!--{$smarty.const.STEXT_LEN}-->" size="60" class="box60" style='<!--{if $arrErr[$item.page_id].robots != ""}-->background-color: <!--{$smarty.const.ERR_COLOR}-->;<!--{/if}-->' /><span class="attention"> (上限<!--{$smarty.const.STEXT_LEN}-->文字)</span></td>
                            </tr>
<!--{* ======================== *}-->                            
                        </table>
