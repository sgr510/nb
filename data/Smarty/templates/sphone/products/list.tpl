...
<section id="product_list">
    ...
    <p class="intro clear"><span class="attention"><span id="productscount"><!--{$tpl_linemax}--></span>件</span>の結果がございます。</p>
...
*}-->              
            <!--{if $orderby != "date"}-->
                <li style="width:100%;"><a href="javascript:fnChangeOrderby('date');" rel="external">新着順</a></li>
            <!--{else}-->
                <li class="on_number" style="width:100%;">新着順</li>
            <!--{/if}-->
        </ul>
    </section>
    <!--▲ページナビ(本文)-->
...
*}-->
            <div class="listrightblock" style="width:95%;">
...
<!--{/if}-->
                <h3><a rel="external" href="<!--{$smarty.const.P_DETAIL_URLPATH}--><!--{$arrProduct.product_id|u}-->" name="product<!--{$arrProduct.product_id}-->" class="productName"><!--{$arrProduct.name|replace:"の通過したES（エントリーシート）":"のES"}--></a></h3>
                <!--★商品価格★-->
<!--{*                
                <p>
