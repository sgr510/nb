...
*}-->
    <section id="detailarea">
        ...
        <!--{if $tpl_login}-->
        	<!--{$arrProduct.customer_comment|nl2br_html}-->
        <!--{else}-->
...
*}-->
                ...
                <!--▼買い物かご-->
<!--{if $arrProduct.product_id > 1 && $arrProduct.price02_min > 1}-->
...
*}-->                       
<!--{* ========= Added by KACR 2013.12.14 ======== *}-->
							<p style="overflow: hidden;"><!--{$arrRecommend[cnt].comment|nl2br_html}--></p>
<!--{* =========================================== *}-->							     
                        </li>
                    <!--{/if}-->
                <!--{/section}-->
