...
class LC_Page_Admin_Basis_Seo extends LC_Page_Admin_Ex {
        ...
        switch ($mode) {
            case 'confirm':
                ...
                if (count($this->arrErr[$device_type_id][$page_id]) == 0) {
                    ...
                    // ========= 2013.12.05 Changed by KACR ==========
                    $arrUpdData = array($arrMETA['author'], $arrMETA['description'], $arrMETA['keyword'], $arrMETA['robots'], $device_type_id, $page_id);
                    // ===============================================
    ...
    function lfInitParam($mode, &$objFormParam) {
        ...
        // ========= 2013.12.05 Changed by KACR ==========
        $objFormParam->addParam('メタタグ:Robots', 'robots', STEXT_LEN, 'KVa', array('MAX_LENGTH_CHECK'));
        // ===============================================
    }
