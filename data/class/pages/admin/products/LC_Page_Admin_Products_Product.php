...
class LC_Page_Admin_Products_Product extends LC_Page_Admin_Products_Ex {
    ...
    function lfInitFormParam(&$objFormParam, $arrPost) {
        ...
        $objFormParam->addParam('会員用コンテンツ', 'customer_comment', LLTEXT_LEN, 'KVa', array('EXIST_CHECK', 'SPTAB_CHECK', 'MAX_LENGTH_CHECK'));
	    $objFormParam->addParam('nofollowフラグ', 'nofollow_flg', INT_LEN, 'n', array('SPTAB_CHECK', 'NUM_CHECK'));
        // =================================================
    ...
    function lfCheckError_Edit(&$objFormParam, &$objUpFile, &$objDownFile, $arrForm) {
        ...
        // ========== 2013.12.05 Added by KACR ===========
        $objErr->doFunc(array('会員用コンテンツ', 'customer_comment', $this->arrAllowedTag), array('HTML_TAG_CHECK'));
        // ===============================================
...
__EOF__;
    ...
    function lfRegistProduct(&$objUpFile, &$objDownFile, $arrList) {
        ...
        // ============ 2013.12.05 Added by KACR ============
        $sqlval['customer_comment'] = $arrList['customer_comment'];
        $sqlval['nofollow_flg'] = $arrList['nofollow_flg'];
        // ==================================================
