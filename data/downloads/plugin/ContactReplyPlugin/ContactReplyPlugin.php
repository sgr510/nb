...
DOC;
    ...
    function contact_before($objPage) {
        ...
        if ($objPage->getMode() == 'complete') {
            ...
            if (SC_Utils_Ex::isBlank($arrErr)) {
                $this->lfRegisterContactData($arrForm);
            }
        }
    }
    ...
    function lfRegisterContactData($arrForm) {
        $objQuery =& SC_Query_Ex::getSingletonInstance();
        $objCustomer = new SC_Customer();

        $sqlval['contact_id'] = $objQuery->nextVal('plg_ContactReply_contact_contact_id');
        $sqlval['name01'] = $_POST['name01'];
        $sqlval['name02'] = $_POST['name02'];
        $sqlval['kana01'] = $_POST['kana01'];
        $sqlval['kana02'] = $_POST['kana02'];
        $sqlval['zip01'] = $_POST['zip01'];
        $sqlval['zip02'] = $_POST['zip02'];
        $sqlval['pref'] = $_POST['pref'];
        $sqlval['addr01'] = $_POST['addr01'];
        $sqlval['addr02'] = $_POST['addr02'];
        $sqlval['tel01'] = $_POST['tel01'];
        $sqlval['tel02'] = $_POST['tel02'];
        $sqlval['tel03'] = $_POST['tel03'];
        $sqlval['email'] = $_POST['email'];
        $sqlval['contents'] = $_POST['contents'];
