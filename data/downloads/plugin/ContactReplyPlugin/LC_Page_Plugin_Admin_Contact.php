...
class LC_Page_Plugin_Admin_Contact extends LC_Page_Admin_Ex {
    ...
    function action() {
        ...
        case 'delete':
            ...
            $objQuery->update("plg_ContactReply_contact", $sqlval);
            break;
        case 'return':
        ...
        $this->arrContacts = $this->lfGetContacts();
    ...
    function lfGetContacts() {
        $objQuery =& SC_Query_Ex::getSingletonInstance();

        $this->tpl_linemax = $objQuery->count("plg_ContactReply_contact", 'del_flg = 0');
        ...
        // お問い合わせ履歴情報の取得
        $arrRet = $objQuery->select('*', 'plg_ContactReply_contact', 'del_flg = 0');
