 ...
 */
*}-->
<!--{include file="`$smarty.const.SMARTPHONE_TEMPLATE_REALDIR`popup_header.tpl" subtitle="ペイパルでログイン"}-->
<script>
$(function() {
...
<!--{include file="`$smarty.const.SMARTPHONE_TEMPLATE_REALDIR`/mypage/login.tpl"}-->
