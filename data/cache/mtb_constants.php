...
/** マイページ会員情報の変更URL */
define('MYPAGE_CHANGE_URLPATH', ROOT_URLPATH . "mypage/favorite.php");
/** 会員登録用コスト */
define('CUSTOMER_COST', 2362);
/** 会員登録完了ページ */
define('ENTRY_COMPLETE_URL', HTTPS_URL . "entry/complete.php");
/** 会員登録用コスト（表示用） */
define('CUSTOMER_COST_LABEL', "2,980");
